...
#   floor            660           7413        14881           7285
#   shipped          213          17485        24524          21555
#   cone             213          26837        32538          19698
#   coneInline       213          53131        52833          40495
#
#   Net of the fixture floor: shipped 10072 / 9643 / 14270 · cone 19424 / 17657 / 12413 ·
#   coneInline 45718 / 37952 / 33210.
#   ★★ THE THREE AXES DISAGREE ON THE DIRECTION FOR `cone`, and that is the reading rather
#   than a defect in it: it allocates 1.93x the list elements and 1.83x the set elements,
...
#   ★★★ THEY DO NOT DISAGREE ABOUT `coneInline`: 4.54x / 3.94x / 2.33x the shipped loop's
...
#   FLOOR      27 27 27 28 27 27 27 27              27       27    0.0%     27
#   NULL       90 91 90 93 90 92 90 91              90       90    0.0%     63
#   SHIPPED    91 89 94 88 89 100 98 90             88       89    1.1%     61
#   ARM        89 89 97 93 89 91 89 99              89       89    0.0%     62
#   Q1         57 53 56 55 56 53 53 57              53       53    0.0%     26
#   CONTROL4X  140 138 138 138 138 139 139 139     138      138    0.0%    111
#
#   P4 NULL-parity PASS (63 vs 61 net, 3.2% apart) · P5 PASS on all six arms against a
#   bound of 12% · CONTROL-4x 4.26x (sensitivity only; it passes in either machine mode
...
#   SHIPPED net 61 ms · ARM net 62 ms · delta 1.6% of the smaller net.
#   RESOLUTION FLOOR = bound 12% x the arm's own min/net 1.44 = 17.3%.
...
let
  ...
  inherit (ci.inputs) gen-prelude gen-graph nixpkgs;
